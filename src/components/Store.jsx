    ...
    <div className="store">
        ...
        <div className="container mt-5">
            <div className="row">
                ...
                <div className="col-lg-4 col-md-6 col-sm-4">
                   <div id="a" className="card " style={{width: "100%"}}>
                ...
                <div className="col-lg-4 col-md-12 col-sm-4">
                   <div id="b" className="card " style={{width: "100%"}}>
            ...
            <div className="row mt-5">
                ...
                <div className="col-lg-4 col-md-6 col-sm-4">
                   <div id="d" className="card " style={{width: "100%"}}>
                ...
                <div className="col-lg-4 col-md-12 col-sm-4">
                   <div id="e" className="card " style={{width: "100%"}}>
